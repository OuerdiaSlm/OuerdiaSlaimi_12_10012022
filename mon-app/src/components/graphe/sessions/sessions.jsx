    ...
    return (
      <section className="average-sessions-section">
        ...
        <div className="sessions-graph">
          <LineChart width={258} height={250} data={session}>
          <Line type="monotone" padding={{ left: 10 }} dataKey="sessionLength" stroke="rgba(255, 255, 255, 0.7)" strokeWidth={2} dot={false} activeDot={{ r: 3, strokeWidth: 8, stroke:'white' }}/>
            <XAxis dataKey="day" tickLine={false} tick={{fontSize: 14, stroke:'white'}} dy={15} />
            <Tooltip content={CustomTooltip} cursor={{ stroke: 'black', strokeOpacity: 0.2, strokeWidth: 50}}
            offset={30}/>
          </LineChart>
        </div>
      </section>
